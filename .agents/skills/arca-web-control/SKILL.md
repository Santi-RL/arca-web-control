...
4. Validar la identidad del receptor según `references/job-v2.md`: CUIT visible exacto y comparación cerrada de la razón social; cualquier diferencia no admitida detiene la preparación. Mostrar emisor, CUIT del emisor, punto de venta, tipo, concepto, moneda, fecha, período, vencimiento, receptor con su CUIT, condición frente al IVA, domicilio, condición de venta, descripción, cantidad, precio unitario, subtotal y total. No inferirlos: deben provenir del resumen estructurado verificado.
